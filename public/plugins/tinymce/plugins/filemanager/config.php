...
$base_url= 'http://'.$_SERVER['SERVER_NAME']; //url base of site if you want only relative url leave empty var_dump($base_url);
$upload_dir = '/web/files/'; // path from base_url to upload base dir

 ...
 */
final class Version20190710094435 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE creation ADD video VARCHAR(255) DEFAULT NULL, CHANGE slider_id slider_id INT DEFAULT NULL, CHANGE image_content image_content VARCHAR(255) DEFAULT NULL, CHANGE image_corps_2 image_corps_2 VARCHAR(255) DEFAULT NULL, CHANGE ordre ordre INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE creation DROP video, CHANGE slider_id slider_id INT DEFAULT NULL, CHANGE image_content image_content VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE image_corps_2 image_corps_2 VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE ordre ordre INT DEFAULT NULL');
        $this->addSql('ALTER TABLE slide CHANGE slider_id slider_id INT DEFAULT NULL, CHANGE tabindex tabindex INT DEFAULT NULL');

 ...
 */
final class Version20190312160845 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE creation ADD img_big_nb VARCHAR(255) NOT NULL, ADD img_small_nb VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE creation DROP img_big_nb, DROP img_small_nb');
    }
}
